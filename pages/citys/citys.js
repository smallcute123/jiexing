...
import qqmap from '../../utils/map';//这里的路径看你自己的文件路径
const app = getApp();
Page({
  data: {
    //下面是字母排序
  ...
  cityTap(e) {
    ...
    if (city) {
      ...
      app.globalData.strcity = this.data.strcity,
        wx.redirectTo({
          url: "/pages/starting/starting",
        })
      console.log(this.data.strcity);
    } else {
      console.log('还没有');
      this.getLocate();
    }
